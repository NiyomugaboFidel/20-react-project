    ...
    <div className="Sidebar">
        <div className="flex flex-col ">
            <div className="profile">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20 " width='100%' height='100%' fill="currentColor" className="size-22">
           ...
           <ul className="flex flex-col">
                <li className="bg-gray-100 py-2 px-2 rounded-md w-full flex justify-around">
                    <span>     
